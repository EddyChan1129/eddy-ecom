  ...
  return (
    <Card className="group hover:shadow-2xl transition duration-300 py-0 h-full flex flex-col border-gray-300 gap-0">
      <div className="relative  h-40 md:h-60 w-full">
        ...
        {isNew && (
          <svg ref={svgRef} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="absolute top-[-10px] left-[-10px] size-8 rounded-md w-8 h-12 p-1 animate-pulse">
